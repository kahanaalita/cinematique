...
// MockActorController is a mock implementation of the ActorController interface
...
func (m *MockActorController) PartialUpdateActor(c *gin.Context, id int, update dto.ActorUpdate) error {
...
// MockMovieController is a mock implementation of the MovieController interface
type MockMovieController struct {
	mock.Mock
}

// Implement all the required methods of MovieController interface
...
// TestMovieHandler_Create tests the Create method of MovieHandler
func TestMovieHandler_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			handler := NewMovieHandler(mockCtrl)
...
// TestMovieHandler_GetByID tests the GetByID method of MovieHandler
...
// TestMovieHandler_List tests the List method of MovieHandler
...
// TestMovieHandler_SearchByTitle tests the SearchByTitle method of MovieHandler
func TestMovieHandler_SearchByTitle(t *testing.T) {
	tests := []struct {
		name           string
		query          string
		setupMock      func(*MockMovieController)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			r.GET("/movies/search", handler.SearchByTitle)
			req, _ := http.NewRequest("GET", "/movies/search?title="+tt.query, nil)
			w := httptest.NewRecorder()
			r.ServeHTTP(w, req)
...
// TestMovieHandler_SearchByActorName tests the SearchByActorName method of MovieHandler
func TestMovieHandler_SearchByActorName(t *testing.T) {
	tests := []struct {
		name           string
		query          string
		setupMock      func(*MockMovieController)
		...
		},
		{
			...
			expectedStatus: http.StatusOK,
			expectedBody:   `{"movies":[{"id":1,"title":"Movie","description":"desc","release_year":2020,"rating":7.5}]}`,
		},
		{
			name:  "controller error",
			query: "error",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			r.GET("/movies/search-by-actor", handler.SearchByActorName)
			req, _ := http.NewRequest("GET", "/movies/search-by-actor?actor="+tt.query, nil)
			w := httptest.NewRecorder()
			r.ServeHTTP(w, req)
...
// TestMovieHandler_CreateWithActors tests the CreateWithActors method of MovieHandler
...
// TestMovieHandler_Update tests the Update method of MovieHandler
...
// TestMovieHandler_PartialUpdate tests the PartialUpdate method of MovieHandler
...
// TestMovieHandler_Delete tests the Delete method of MovieHandler
...
// TestMovieHandler_UpdateMovieActors tests the UpdateMovieActors method of MovieHandler
...
// TestMovieHandler_ListSorted tests the ListSorted method of MovieHandler
...
// TestMovieHandler_AddActorToMovie tests the AddActorToMovie method of MovieHandler
func TestMovieHandler_AddActorToMovie(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			movieID, err1 := strconv.Atoi(tt.movieID)
			actorID, err2 := strconv.Atoi(tt.actorID)
...
// TestMovieHandler_RemoveActorFromMovie tests the RemoveActorFromMovie method of MovieHandler
...
// TestMovieHandler_GetActorsForMovieByID tests the GetActorsForMovieByID method of MovieHandler
...
// TestMovieHandler_GetMoviesForActor tests the GetMoviesForActor method of MovieHandler
